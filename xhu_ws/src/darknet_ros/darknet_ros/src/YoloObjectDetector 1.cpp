...
/////////////修改
          ...
          const double w1 = 20;
          const double h1 = 30; 
          const double y_200 = 18000;
          const double y_300 = 8500;
          const double y_400 = 5200;
          const double y_500 = 3950;
          const double x_200 = 11000/2;
          const double x_300 = 5200/2;
          const double x_400 = 3400/2;
          const double x_500 = 2560/2;

          double ky_200_300, ky_300_400, ky_400_500;
          double by_200_300, by_300_400, by_400_500;

          double kx_200_300, kx_300_400, kx_400_500;
          double bx_200_300, bx_300_400, bx_400_500;

          ky_200_300 = (y_200 - y_300)/100;
          ky_300_400 = (y_300 - y_400)/100;
          ky_400_500 = (y_400 - y_500)/100;

          by_200_300 = y_200 + ky_200_300*200;
          by_300_400 = y_300 + ky_300_400*300;
          by_400_500 = y_400 + ky_400_500*400;


          kx_200_300 = (x_200 - x_300)/100;
          kx_300_400 = (x_300 - x_400)/100;
          kx_400_500 = (x_400 - x_500)/100;


          bx_200_300 = x_200 + kx_200_300*200;
          bx_300_400 = x_300 + kx_300_400*300;
          bx_400_500 = x_400 + kx_400_500*400;
          ...
          if (xcen>0 && xcen<=400 && ymax>200 && ymax<=300)
          {
            distancey = -ky_200_300*ymax + by_200_300;
            distancex = (-kx_200_300*ymax + bx_200_300)/400*(xcen-400);
            //distancex = ((x2-x1)*(ymax-200)/100+x1)*(400-xcen)/400;
            //distancey = (y2-y1)*(300-ymax)/100+y2;
            ROS_INFO("distancex = %d!!!!", distancex);
          }
          else if (xcen>400 && xcen<=800 && ymax>200 && ymax<=300)
          {
            distancey = -ky_200_300*ymax + by_200_300;
            distancex = (-kx_200_300*ymax + bx_200_300)/400*(xcen-400);
          ...
          else if (xcen>0 && xcen<=400 && ymax>300 && ymax<=400)
          {
            distancey = -ky_300_400*ymax + by_300_400;
            distancex = (-kx_300_400*ymax + bx_300_400)/400*(xcen-400);
          ...
          else if (xcen>400 && xcen<=800 && ymax>300 && ymax<=400)
          {
          ...
          else if (xcen>0 && xcen<=400 && ymax>400 && ymax<=500)
          {
            distancey = -ky_400_500*ymax + by_400_500;
            distancex = (-kx_400_500*ymax + bx_400_500)/400*(xcen-400);
          ...
          else if (xcen>400 && xcen<=800 && ymax>400 && ymax<=500)
          {
            distancey = -ky_400_500*ymax + by_400_500;
            distancex = (-kx_400_500*ymax + bx_400_500)/400*(xcen-400);
            //distancey = -12.5*ymax+10200;
